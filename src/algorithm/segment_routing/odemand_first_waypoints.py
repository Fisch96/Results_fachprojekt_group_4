...
class ODemandsFirstWaypoints(GenericSR):
    BIG_M = 10 ** 9
    ...
    def __odemands_first_waypoints(self):
        """ main procedure """
    ...
    def solve(self) -> dict:
        ...
        loads, waypoints, objective = self.__odemands_first_waypoints()
    ...
    def get_name(self):
        ...
        return f"odemand_first_waypoints"
